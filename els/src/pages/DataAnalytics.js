...
import DSlottie from '../packages/DALottie.json';
...
<div class="grid sm:grid-cols-2 my-20 w-full bg-transparent p-10 ">
         <div class=" my-auto">
            ...
            Learn essential skills like data cleaning, analysis, and visualization to make data-driven decisions..</p>
...
<div class="h-auto my-auto bg-blue-50">
    ...
    <div class="bg-transparent p-10 shadow-sm">
        <h3 class="text-4xl font-serif text-gray-800 mb-4">Overview of Data Analytics modules
  ...
  >
    <div class="flex cursor-pointer items-center justify-between text-xl">
      <span> Basic Math and Statistics for Data Analysis:  </span>
      <img
    ...
    >
      EXplore topics such as arithmetic, percentages, averages, standard deviation, and correlation. In addition, learn how to apply statistical methods to analyze and interpret data effectively.
    </div>
  </div>
  ...
  >
    <div class="flex cursor-pointer items-center justify-between text-xl">
      <span> Introduction to Spreadsheets: </span>
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/9/96/Chevron-icon-drop-down-menu-WHITE.png"
        class="h-2 w-3 transition-all duration-500 group-focus:-rotate-180"
      />
    ...
    <div
      class="invisible text-lg mt-2 font-mono h-auto max-h-0 items-center opacity-0 transition-all group-focus:visible group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000"
    >
      Dive into the world of spreadsheet software, focusing on Microsoft Excel. Master essential functionalities including data entry, formula creation, manipulation, and basic data visualization. 
    </div>
  </div>
  ...
  >
    <div class="flex cursor-pointer items-center justify-between text-xl">
      <span> Data Visualization Software and Business Fundamentals: </span>
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/9/96/Chevron-icon-drop-down-menu-WHITE.png"
        class="h-2 w-3 transition-all duration-500 group-focus:-rotate-180"
      />
    ...
    >
      Explore the use of data visualization software, focusing on PowerBI. Gain hands-on experience in creating interactive dashboards and reports to visualize and analyze data effectively. Additionally, learn essential business fundamentals to understand how data analytics can drive informed decision-making and contribute to organizational success.
    </div>
  </div>
  ...
  >
    ...
    <div
      class="invisible text-lg mt-2 font-mono h-auto max-h-0 items-center opacity-0 transition-all group-focus:visible group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000"
    >
      Explore the fundamentals of relational databases and Structured Query Language (SQL). Learn how to create, retrieve, update, and manage data stored in relational database management systems (RDBMS)
    </div>
  </div>
  <div
    class="group flex flex-col gap-2 rounded-lg bg-blue-400 p-5 text-white"
  ...
  >
    <div class="flex cursor-pointer items-center justify-between text-xl">
      <span> Data Visualization and Wrangling (Pandas and Matplotlib): </span>
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/9/96/Chevron-icon-drop-down-menu-WHITE.png"
        class="h-2 w-3 transition-all duration-500 group-focus:-rotate-180"
      />
    ...
    <div
      class="invisible text-lg mt-2 font-mono h-auto max-h-0 items-center opacity-0 transition-all group-focus:visible group-focus:max-h-screen group-focus:opacity-100 group-focus:duration-1000"
    >
       Learn how to clean, transform, and manipulate data for analysis. Explore techniques for creating insightful visualizations to effectively communicate findings and uncover patterns in the data.
    </div>
  </div>
</div>
    </div>
